...
equiv_proton_momentum = 450e9 # eV/c = gamma_p*m_p*v
...
lambda_l = lambda_l*(1+2*sigma_dp) # m

laser_frequency = c/lambda_l # Hz
sigma_w = 2*np.pi*laser_frequency*sigma_dp*2
...
GF_IP = xt.IonLaserIP(_buffer=buf,
                      ...
                      laser_waist_radius = 2e-3, # m
                      ion_excitation_energy = hw0, # eV
                      ion_excited_lifetime  = 0.4279e-12, # sec
                     )
